...
import { ArrowLeft, Edit, User, Mail, Phone, Calendar, MapPin, Briefcase, Heart, Clock } from "lucide-react"
...
export default function ViewEmployee({ params }: { params: { id: string } }) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">View employee information</p>
              </div>
            </div>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-xl text-red-400 mb-4">{employee.designation || "No designation"}</p>
                  <div className="flex flex-wrap justify-center md:justify-start gap-2">
                    ...
                    <Badge
                      variant={employee.password ? "default" : "destructive"}
                      className={employee.password ? "bg-green-600" : "bg-red-600"}
                    >
                      {employee.password ? "Registered" : "Pending Registration"}
                    </Badge>
                  </div>
                </div>
              </div>
          ...
          {(employee.designation || employee.experience || employee.dateOfJoining) && (
            <Card className="bg-gray-800/50 border-gray-700 mt-6">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Employee role and experience details</CardDescription>
              </CardHeader>
              <CardContent>
